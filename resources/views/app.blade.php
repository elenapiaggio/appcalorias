...
<nav class="navbar navbar-default">
    <!-- Para ver el menu en fondo negronegro -->
    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">AppCalorias</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="{{ url('/calcularkcal') }}">Contador calorias</a></li>
                <li><a href="{{ url('/food/list') }}">Listar Alimentos</a></li>
            </ul>
...
<div class="center-block">
    <div class="container">
            <div class="pull-left">
                <img src="img/appcalories.png" class="img-responsive" alt="Logo AppCalorias">
            </div>
